...
class TransactionsApi(object):
    ...
    @auto_fill
    @validate_call
    def get_transaction(self, id : Annotated[UUID, Field(description="The universally unique identifier of the resource.")], tx_type : Annotated[Optional[TransactionType], Field(description="Filter by on the transaction type.")] = None, x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> TransactionResponse:  # noqa: E501
