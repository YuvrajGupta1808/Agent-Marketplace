...
class WalletsApi(object):
    ...
    @auto_fill
    @validate_call
    def create_wallet(self, create_wallet_request : Annotated[CreateWalletRequest, Field(description="Schema for the request payload to create a new wallet.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> Wallets:  # noqa: E501
        ...
        :param x_request_id: Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. 
    ...
    def create_wallet_with_http_info(self, create_wallet_request : Annotated[CreateWalletRequest, Field(description="Schema for the request payload to create a new wallet.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        if _params['x_request_id']:
            param_value = _params['x_request_id']
            if isinstance(param_value, uuid.UUID):
                param_value = str(param_value)
            _header_params['X-Request-Id'] = param_value
    ...
    @auto_fill
    @validate_call
    def derive_wallet(self, id : Annotated[UUID, Field(description="The universally unique identifier of the resource.")], blockchain : Annotated[EvmBlockchain, Field(description="The unique identifier of the blockchains.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, derive_wallet_request : Annotated[Optional[DeriveWalletRequest], Field(description="Defines the request payload schema for deriving a new wallet.")] = None, **kwargs) -> WalletResponse:  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def derive_wallet_with_http_info(self, id : Annotated[UUID, Field(description="The universally unique identifier of the resource.")], blockchain : Annotated[EvmBlockchain, Field(description="The unique identifier of the blockchains.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, derive_wallet_request : Annotated[Optional[DeriveWalletRequest], Field(description="Defines the request payload schema for deriving a new wallet.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Derive a wallet  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def derive_wallet_by_address(self, derive_wallet_by_address_request : Annotated[DeriveWalletByAddressRequest, Field(description="Request payload to derive a wallet by source blockchain + address onto a target blockchain.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> WalletResponse:  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def derive_wallet_by_address_with_http_info(self, derive_wallet_by_address_request : Annotated[DeriveWalletByAddressRequest, Field(description="Request payload to derive a wallet by source blockchain + address onto a target blockchain.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Derive wallet by address  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def get_wallet(self, id : Annotated[UUID, Field(description="The universally unique identifier of the resource.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> WalletResponse:  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def get_wallet_with_http_info(self, id : Annotated[UUID, Field(description="The universally unique identifier of the resource.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve a wallet  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def get_wallets_with_balances_with_http_info(self, blockchain : Annotated[Blockchain, Field(description="Filter by blockchain.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, address : Annotated[Optional[StrictStr], Field(description="Filter by the blockchain address of the wallet.")] = None, sca_core : Annotated[Optional[ScaCore], Field(description="Filters results by the SCA version.")] = None, wallet_set_id : Annotated[Optional[UUID], Field(description="Filter by the wallet set.")] = None, ref_id : Annotated[Optional[StrictStr], Field(description="Filter by the reference identifier.")] = None, amount__gte : Annotated[Optional[StrictStr], Field(description="Filters wallets with a balance greater than or equal to the specified amount. If `tokenAddress` is provided, the filter applies to the specified token; otherwise, it applies to the native token.")] = None, token_address : Annotated[Optional[StrictStr], Field(description="Filter by token address.")] = None, var_from : Annotated[Optional[datetime], Field(description="Queries items created since the specified date-time (inclusive) in ISO 8601 format.")] = None, to : Annotated[Optional[datetime], Field(description="Queries items created before the specified date-time (inclusive) in ISO 8601 format.")] = None, page_before : Annotated[Optional[UUID], Field(description="A collection ID value used for pagination.  It marks the exclusive end of a page. When provided, the collection resource will return the next n items before the id, with n being specified by pageSize.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither pageAfter nor pageBefore are specified.   SHOULD NOT be used in conjunction with pageAfter. ")] = None, page_after : Annotated[Optional[UUID], Field(description="A collection ID value used for pagination.  It marks the exclusive begin of a page. When provided, the collection resource will return the next n items after the id, with n being specified by pageSize.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither pageAfter nor pageBefore are specified.  SHOULD NOT be used in conjunction with pageBefore. ")] = None, page_size : Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Limits the number of items to be returned.  Some collections have a strict upper bound that will disregard this value. In case the specified value is higher than the allowed limit, the collection limit will be used.  If avoided, the collection will determine the page size itself. ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List wallets with balances  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def update_wallet(self, id : Annotated[UUID, Field(description="The universally unique identifier of the resource.")], update_wallet_request : Annotated[UpdateWalletRequest, Field(description="Schema for the request payload to update an existing wallet.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> WalletResponse:  # noqa: E501
