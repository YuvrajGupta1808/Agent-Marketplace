...
class WebhookSubscriptionsApi(object):
    ...
    @auto_fill
    @validate_call
    def create_subscription(self, create_subscription_request : Annotated[CreateSubscriptionRequest, Field(description="Schema for the request payload to create a new subscription.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> SubscriptionResponse:  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def delete_subscription_with_http_info(self, id : Annotated[UUID, Field(description="The universally unique identifier of the resource.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a notification subscription  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def get_notification_signature_with_http_info(self, id : Annotated[UUID, Field(description="The universally unique identifier of the resource.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get a notification signature public key  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def get_subscription(self, id : Annotated[UUID, Field(description="The universally unique identifier of the resource.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> SubscriptionResponse:  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def get_subscription_with_http_info(self, id : Annotated[UUID, Field(description="The universally unique identifier of the resource.")], x_request_id : Annotated[Optional[UUID], Field(description="Developer-provided identifier for this request, used for tracing requests in Wallets API logs and the Developer Console, and when communicating with Circle Support. **Must be a UUID to appear in logs.** Non-UUID values are accepted by the API but are ignored by logging and tracing systems. ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve a notification subscription  # noqa: E501
